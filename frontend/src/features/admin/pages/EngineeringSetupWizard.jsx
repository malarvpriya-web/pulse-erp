...
import {
  Layers, GitBranch, RotateCcw, CheckSquare, HardDrive, ChevronRight,
  ChevronLeft, Check, PlayCircle, CheckCircle, Star, Save, FolderOpen,
  ArrowLeft, DraftingCompass,
} from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fafbff', fontFamily: 'inherit' }}>
      ...
      <PageHero
        ...
        eyebrow="Setup"
        title="Engineering Setup Wizard"
