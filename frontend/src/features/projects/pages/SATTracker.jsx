...
import { MapPin, Plus, X, RefreshCw, CheckCircle, ShieldCheck } from 'lucide-react';
  ...
  return (
    <PageShell dock={
      <PageHero
        icon={ShieldCheck}
        eyebrow="Projects"
        title="SAT Tracker — Site Acceptance Tests"
        subtitle="Conduct and record customer-witnessed site acceptance testing with formal sign-off"
        actions={<>
