...
Project Alpha Assembly,1,Nos,Control Panel,1,Nos,45000,0
Site Enclosure Kit,1,Nos,GI Sheet 2mm,6,Nos,3500,1.5
Site Enclosure Kit,1,Nos,Cable Tray,2,Nos,1200,0`;
    ...
    <div style={{ padding: 24, maxWidth: 820 }}>
      ...
      <div style={{ background: '#f5f3ff', border: '1px solid #e9e4ff', borderRadius: 12, padding: '16px 20px', marginBottom: 20 }}>
        ...
        <ul style={{ margin: '0 0 14px', paddingLeft: 20, fontSize: 12, color: '#6b7280', lineHeight: 1.7 }}>
          <li><strong>finished_product</strong> — product/assembly name (rows with the same name are grouped into one BOM)</li>
          <li><strong>quantity</strong>, <strong>unit</strong> — BOM run quantity and unit (e.g. 1, Nos)</li>
          <li><strong>component_name</strong> — raw material or sub-assembly name</li>
          <li><strong>component_qty</strong>, <strong>component_unit</strong> — quantity and unit per BOM run</li>
      ...
      <div style={{ background: '#fff', border: '2px dashed #e9e4ff', borderRadius: 12, padding: 32, textAlign: 'center', marginBottom: 20 }}>
        ...
        <input
          ...
          onChange={handleFile}
          style={{ display: 'none' }}
          id="proj-bom-file-input"
        />
        <label htmlFor="proj-bom-file-input"
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={handleUpload} disabled={uploading || !csvText}
            style={{
              ...
              cursor: uploading || !csvText ? 'not-allowed' : 'pointer',
          ...
          {csvText && (
            <button onClick={reset}
              style={{ padding: '10px 18px', border: '1px solid #e5e7eb', borderRadius: 8, background: '#fff', cursor: 'pointer', fontSize: 13 }}>
              Clear
            </button>
          )}
        </div>
