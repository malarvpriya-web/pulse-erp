...
import '../shared/recruitment-ui.css';
...
// ─────────────────────────────────────────────────────────────────────────────
// Scheduling + timeline content — the "Schedule" tab of the Interviews page
// (Pulse/frontend/src/features/recruitment/pages/InterviewScheduler.jsx). Split
// out 2026-08-12 so Question Bank could be folded in as a sibling tab without
// touching either page's internals — see InterviewScheduler.jsx.

const InterviewScheduleTab = ({ setPage }) => {
  ...
  return (
    <PageShell dock={
      <PageHero
        ...
        actions={<>
          {dateFilter && (
            <button className="plh-cta plh-cta--ghost" onClick={() => setDateFilter('')}>Clear date</button>
          )}
